...
public void addColorTab()
{
	...
	this.darkenChooserPanelFor(component);
}
...
public void darkenChooserPanelFor(JColorChooser acp)
{
 	AbstractColorChooserPanel[] arr=acp.getChooserPanels();
 	for(AbstractColorChooserPanel ac:arr)
 	{
